...
export const stakePoolMetadatas: StakePoolMetadata[] = [
  ...
  // },
  {
    ...
    nameInHeader: true,
    stakePoolAddress: new PublicKey(
      '7cCKDw42YmTCNVJbTj6TrgL2kb963hRMu8LqUacsTsD3'
    ),
    websiteUrl: 'https://solscan.io/token/CXuPQBQ1fjcoEv7AftPNG9nK3KCSpRNMGtRcdANKwyAc',
    receiptType: ReceiptType.Original,
    maxStaked: 8000,
    imageUrl: 'https://www.arweave.net/bMQaqzpku3vdjW7tM34U_bVAavl6l7VGvc1Yq-smOXs?ext=png',
  },
]
